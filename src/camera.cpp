...
Camera::FixedCamera Camera::createPerspectiveCam(double pX, double pY, double pZ, double tX, double tY, double tZ, int arX, int arY)
{
    srand(time((0)));
...
Camera::FixedCamera Camera::createOrthoCam(int arX, int arY)
{
    srand(time((0)));
    fixedCamera.id                   =   1 + (rand() % 2147483647);
